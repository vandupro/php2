<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <form action="" method="GET"
        ...
        <div class="input-group">
            <input name="keyword" @isset($_GET['keyword']) value="{{$_GET['keyword']}}" @endisset type="text"
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{$_SESSION[AUTH]['email']}}</span>
                <img class="img-profile rounded-circle" src="{{PUBLIC_URL . $_SESSION[AUTH]['image']}}">
            </a>
