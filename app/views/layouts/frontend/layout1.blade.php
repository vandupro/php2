...
<body> 
	...
	<div class="bnr" id="home">
		<div  id="top" class="callbacks_container">
			<ul class="rslides" id="slider4">
			    <li>
					<img src="{{THEME_FONTEND_URL}}images/bnr-1.jpg" alt=""/>
				</li>
				<li>
					<img src="{{THEME_FONTEND_URL}}images/bnr-2.jpg" alt=""/>
				</li>
				<li>
					<img src="{{THEME_FONTEND_URL}}images/bnr-3.jpg" alt=""/>
				</li>
			</ul>
		</div>
	...
	<!--banner-ends--> 
	<!--Slider-Starts-Here-->
				<script src="{{THEME_FONTEND_URL}}js/responsiveslides.min.js"></script>
			 <script>
			...
			<div class="about-top grid-1">
				<div class="col-md-4 about-left">
					<figure class="effect-bubba">
						<img class="img-responsive" src="{{THEME_FONTEND_URL}}images/abt-1.jpg" alt=""/>
						<figcaption>
				...
				<div class="col-md-4 about-left">
					<figure class="effect-bubba">
						<img class="img-responsive" src="{{THEME_FONTEND_URL}}images/abt-2.jpg" alt=""/>
						<figcaption>
				...
				<div class="col-md-4 about-left">
					<figure class="effect-bubba">
						<img class="img-responsive" src="{{THEME_FONTEND_URL}}images/abt-3.jpg" alt=""/>
						<figcaption>
