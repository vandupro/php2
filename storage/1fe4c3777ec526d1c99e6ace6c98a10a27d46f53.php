<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <form action="" method="GET"
        ...
        <div class="input-group">
            <input name="keyword" <?php if(isset($_GET['keyword'])): ?> value="<?php echo e($_GET['keyword']); ?>" <?php endif; ?> type="text"
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e($_SESSION[AUTH]['email']); ?></span>
                <img class="img-profile rounded-circle" src="<?php echo e(PUBLIC_URL . $_SESSION[AUTH]['image']); ?>">
            </a>
...
</nav><?php /**PATH D:\xampp\htdocs\php2\mvc\app\views/layouts/header.blade.php ENDPATH**/ ?>