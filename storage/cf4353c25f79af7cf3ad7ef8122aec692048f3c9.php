...
<div class="container">
        <h3 style="color:green"><> Tất cả sản phẩm:</h3>
</div>
<div class="product">
    <div class="container">
        <div class="prdt-top">
                ...
                <div class="product-one">
                    ...
                    <div class="col-md-4 product-left p-left">
                        <div style="height: 400px" class="product-main simpleCart_shelfItem">
                            <a href="<?php echo e(BASE_URL . 'product-detail/' . $product->id); ?>" class="mask"><img
                                    class="img-responsive zoom-img" src="<?php echo e(PUBLIC_URL . $product->image); ?>" alt="" style="height: 200px" /></a>
                            <div style="padding: 0 15px" class="product-bottom">
                                <h3><?php echo e($product->name); ?></h3>
                                <p>Explore Now</p>
                                <h4>
                                    <!-- <a class="item_add" href="#"><i></i></a>  -->
                                    <span class=" item_price">$ <?php echo e(number_format($product->price, 0)); ?></span>
                                </h4>
                            </div>
    ...
    <ul class="pagination">
        <?php for($i = 1; $i <= $totalPage; $i++): ?>
            <li class="page-item  <?php echo e($i==$page?'active':''); ?>">
                <a class="page-link" href="<?php echo e(BASE_URL . 'product/'. $i); ?>"><?php echo e($i); ?> <span class="sr-only">(current)</span></a>
            </li>
        <?php endfor; ?>
    </ul>
</nav>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\php2\mvc\app\views/frontend/All.blade.php ENDPATH**/ ?>